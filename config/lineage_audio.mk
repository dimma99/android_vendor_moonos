...
ALARM_PATH := vendor/moonos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/moonos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/moonos/prebuilt/common/media/audio/ringtones
